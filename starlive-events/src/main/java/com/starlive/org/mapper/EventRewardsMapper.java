...
public interface EventRewardsMapper extends BaseMapper<EventRewards> {
    @Insert("INSERT INTO event_rewards (event_id, reward_name, description, quantity, distributed, create_time) " +
            "VALUES (#{eventId}, #{rewardName}, #{description}, #{quantity}, #{distributed}, CURRENT_TIMESTAMP)")
